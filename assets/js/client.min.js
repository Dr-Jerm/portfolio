...
(function() {
  ...
  root.app.controller("portfolioController", function($scope, $timeout, Server) {
    ...
    $scope.paddingHidden = function(index, achievementsLength) {
      var achievementsIsEven, isLast, isSecondFromLast, isThirdFromLast;
      ...
      return isLast || (isSecondFromLast && achievementsIsEven) || (isThirdFromLast && achievementsIsEven);
    };
...
root.app.directive('blob', function($timeout) {
  return {
    restrict: 'E',
    scope: {
      details: '=',
