...
(function() {
  ...
  root.app.controller("portfolioController", function($scope, $timeout) {
    $scope.loaded = false;
    ...
    $scope.getInnerWidthStyle = function(css) {
      var style;
      style = {};
...
root.app.directive('youtube', function($sce) {
  return {
    restrict: 'E',
    scope: {
      hash: '@'
    ...
    link: function($scope, element, attrs) {
      ...
      return $scope.$watch('hash', function(newVal) {
        if (newVal) {
          return $scope.url = $sce.trustAsResourceUrl("http://www.youtube.com/embed/" + newVal);
        }
      });
    }
  };
